            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <div style="display: flex; flex-direction: column; justify-content: center; align-items: center; height: 100vh; margin: 0; gap: 20px;">
                            <h1 style="margin: 0;">Selamat Datang</h1>
                            <div style="display: flex; flex-direction: column; align-items: center; gap: 10px;">    
                              <button class="gradient-button" onclick="window.location.href='index.html'">Login</button>
                              <a class="small" href="password.html">Registrasi</a>
                            </div>
                        </div>
